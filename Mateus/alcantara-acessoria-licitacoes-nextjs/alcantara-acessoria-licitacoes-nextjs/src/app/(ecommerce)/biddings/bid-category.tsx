...
import { filterOptions, initialState } from "./filter-category-utils";
...
export default function BidCategory() {
  ...
  return (
    <>
      <div
        ref={ref}
        className=" flex w-full items-center gap-2.5 overflow-x-auto pb-[15px] [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
        <Button
