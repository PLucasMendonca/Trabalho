...
pasta_matriz = Path(r'C:\Users\MSI Pulse\Documents\Chatpdf\Alcantara Mendes\RESUMIDOR\FEITO')

# Pasta de destino para salvar os arquivos JSON
pasta_destino = Path(r'C:\Users\MSI Pulse\Documents\Chatpdf\Alcantara Mendes\RESUMIDOR\RESPOSTAS')
